--Source Code: Kevin Lu
--Modified by: Matthew Ross
--Implemented by: Julia Chung
...
-- IF (pixel_col >= ball_x - size) AND               just commenting out instead of deleting
...
-- allow for bouncing off of sides
