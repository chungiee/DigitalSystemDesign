...
HD_PWD='C:/Users/kojul/DSD/dsd/Labs/leddec/leddec.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log leddec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source leddec.tcl
