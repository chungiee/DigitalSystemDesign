...
HD_PWD='C:/Users/kojul/DSD/dsd/Labs/leddec/leddec.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log leddec.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source leddec.tcl -notrace
